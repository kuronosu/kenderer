...
// counter-clockwise triangles per face). Faces are tinted distinct colors so
// the rotating result reads clearly.
func NewCube(size float64) *Mesh {
	...
	faces := []face{
		{v(1, 0, 0), v(0.90, 0.10, 0.10), [4]math3d.Vec3{v(h, -h, h), v(h, -h, -h), v(h, h, -h), v(h, h, h)}},      // +X
		{v(-1, 0, 0), v(0.10, 0.70, 0.20), [4]math3d.Vec3{v(-h, -h, -h), v(-h, -h, h), v(-h, h, h), v(-h, h, -h)}}, // -X
		{v(0, 1, 0), v(0.15, 0.35, 0.90), [4]math3d.Vec3{v(-h, h, h), v(h, h, h), v(h, h, -h), v(-h, h, -h)}},      // +Y
		{v(0, -1, 0), v(0.95, 0.80, 0.10), [4]math3d.Vec3{v(-h, -h, -h), v(h, -h, -h), v(h, -h, h), v(-h, -h, h)}}, // -Y
		{v(0, 0, 1), v(0.80, 0.15, 0.70), [4]math3d.Vec3{v(-h, -h, h), v(h, -h, h), v(h, h, h), v(-h, h, h)}},      // +Z
		{v(0, 0, -1), v(0.10, 0.75, 0.80), [4]math3d.Vec3{v(h, -h, -h), v(-h, -h, -h), v(-h, h, -h), v(h, h, -h)}}, // -Z
	}
